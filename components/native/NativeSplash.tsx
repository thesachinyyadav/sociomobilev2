...
export default function NativeSplash({ onComplete }: NativeSplashProps) {
  ...
  useEffect(() => {
    // Enforce a minimum display duration of 800ms for the transition layer
    // to allow progress bar crawling and watermark/waves visibility
  ...
  useEffect(() => {
    // Once authentication/session loading completes and minimum display time has elapsed,
    // finish the progress bar and transition out.
  ...
  }, [authLoading, minimumTimeElapsed, onComplete]);
  ...
  return (
    ...
    >
      ...
      {/* Centered Logo badge (Sized perfectly to match the 108dp Android 12+ system splash icon mask and visual logo bounds) */}
      <div className="relative z-10 flex flex-col items-center">
        <div className="w-[108px] h-[108px] rounded-full overflow-hidden bg-white flex items-center justify-center">
          <img
            src="/applogo.png"
            alt="SOCIO Logo"
