    ...
    <div className="scan-page animate-fade-in">
      ...
      <div className="scan-main-column px-4 -mt-24 relative z-20 pb-24 max-w-[480px] mx-auto w-full flex-shrink-0 flex flex-col gap-6">
        ...
        <div className="w-full bg-white relative rounded-[28px] shadow-[0_12px_40px_rgba(1,31,123,0.08)] p-5 flex flex-col items-center">
          <section
            className="w-full relative rounded-[20px] overflow-hidden skeleton"
            style={{ aspectRatio: '1' }}
          >
            {/* Inner frame lines for realism */}
            <div className="absolute inset-0 flex flex-col items-center justify-center z-30">
                <div className="absolute inset-0 p-6 pointer-events-none opacity-20">
                   <div className="absolute top-6 left-6 w-10 h-10 border-t-[3px] border-l-[3px] border-[#94A3B8] rounded-tl-[16px]" />
                   <div className="absolute top-6 right-6 w-10 h-10 border-t-[3px] border-r-[3px] border-[#94A3B8] rounded-tr-[16px]" />
                   <div className="absolute bottom-6 left-6 w-10 h-10 border-b-[3px] border-l-[3px] border-[#94A3B8] rounded-bl-[16px]" />
                   <div className="absolute bottom-6 right-6 w-10 h-10 border-b-[3px] border-r-[3px] border-[#94A3B8] rounded-br-[16px]" />
                </div>
            </div>
          </section>

          <div className="mt-5 w-full max-w-[320px] h-[52px] skeleton rounded-[14px]" />
        </div>

        {/* Recent Scans Skeleton */}
        <section className="bg-white rounded-[24px] border border-[#F1F5F9] shadow-[0_4px_24px_rgba(15,23,42,0.03)] flex flex-col overflow-hidden">
